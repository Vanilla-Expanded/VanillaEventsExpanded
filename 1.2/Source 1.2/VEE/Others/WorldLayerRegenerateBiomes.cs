...
{
    class WorldLayerRegenerateBiomes : WorldLayer
    {
        ...
        public override IEnumerable Regenerate()
        {
            ...
            if (VEEData.toRegenerate == null)
            {
                yield break;
            }
            if (VEEData.toRegenerate.Count == 0)
            {
                yield break;
            }
            ...
            foreach (int num in VEEData.toRegenerate)
            {
                if (num >= 0)
                {
        ...
        private IEnumerable CalculateInterpolatedVerticesParams()
        {
            ...
            {
                if (VEEData.toRegenerate.Contains(i))
                {
                    Tile tile = tiles[i];
